...
public class AparelhoController {
    ...
    public ResponseEntity<AparelhoResponseDTO> atualizar(
            @PathVariable Long id,
            @Valid
            @RequestBody AparelhoUpdateDTO request
    ) {

        return ResponseEntity.ok(
                aparelhoService.atualizar(
                        id,
                        request
                )
        );
